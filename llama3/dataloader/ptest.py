...
class PTest(BaseDataset):
    def __init__(self, args=None, tokenizer=None, split='train'):
        ...
        if args.use_cap:
            self.caption = json.load(open(f'./data/ptest/caption_{args.cap_model}.json'))
        self.mm_features = {}
        self.mm_texts = {}
        ...
        if args.use_box:
            box_folder = './data/ptest/bbox'
            data = json.load(open(f'./data/ptest/bbox_{args.box_format}.json'))
