...
--dataset ptest \
--use_cap \
--output_dir ./checkpoint/ptest_cap \
...
--num_workers 16 \
--llama_model_path $model_path \
--resume ./checkpoint/ptest_cap/checkpoint_best.pth \
--max_seq_len 2200 \
--batch_size 1 \
--accum_iter 8 \
--epochs 10 \
...
--use_box \
--box_format textual \
--output_dir ./checkpoint/ptest_cap_box \
--project_name objectmllm_ptest
...
--num_workers 16 \
--llama_model_path $model_path \
--resume ./checkpoint/ptest_cap_box/checkpoint_best.pth \
--max_seq_len 2200 \
--batch_size 1 \
--accum_iter 8 \
--epochs 10 \
